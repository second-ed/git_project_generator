...
class GitProjectGenerator:
    ...
    def create_git_dir(self) -> None:
        ...
        essential_files: dict[str, str] = {
            f"{project_root}/.github/workflows/run_tests.yaml": self.get_template_file_str("run_tests.yaml"),
            ...
            f"{project_root}/.gitignore": self.get_template_file_str(".gitignore"),
            f"{project_root}/pyproject.toml": self.get_template_file_str("pyproject.toml").replace("REPLACE_PROJECT_NAME", self.project_name).replace("REPLACE_PROJECT_AUTHOR", self.project_author),
            f"{project_root}/src/config.py": self.get_template_file_str("config.py"),
